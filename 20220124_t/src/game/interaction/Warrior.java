...
public class Warrior {
	// Warrior의 특성으로
	// 체력(hp), 마나(mp), 공격력(atk), 경험치(exp), 레벨(lv)를 넣어주세요 (멤버변수)
	private int hp;
	private int mp;
	private int atk;
	private int exp;
	...
	// 체력은 20, 마나는 10, 공격력은 4, 레벨은 1, 경험치는 0이 자동입력되게 해주세요. (생성자)
	public Warrior() {
		this.hp = 20;
		this.mp = 10;
		this.atk = 4;
	...
	public void huntMonster1(Monster1 monster1) {
		...
		// 전사의 공격으로 죽은 경우 경험치를 10 더해주시고
		// 죽었습니다. 라는 멘트가 뜨고 메서드가 종료되게 해주세요.
